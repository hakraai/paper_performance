...
At this point there is no literal reproduction of the figures, as the cleanup of the repository and environment led to a small difference, probably related to random number generation. We are looking into this. Perhaps we will replace the figures in the manuscript with the ones generated by the code in this repository to be fully consistent.
